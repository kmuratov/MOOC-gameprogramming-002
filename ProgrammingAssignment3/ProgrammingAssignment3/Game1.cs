...
namespace ProgrammingAssignment3
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        private Texture2D greenRockTexture;
        private Texture2D magentaRockTexture;
        private Texture2D whiteRockTexture;
        ...
        protected override void LoadContent()
        {
            ...
            greenRockTexture = Content.Load<Texture2D>("greenrock");
            magentaRockTexture = Content.Load<Texture2D>("magentarock");
            whiteRockTexture = Content.Load<Texture2D>("whiterock");
