...
namespace ProgrammingAssignment2
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            sprite0 = Content.Load<Texture2D>("img1");
            sprite1 = Content.Load<Texture2D>("img2");
            sprite2 = Content.Load<Texture2D>("img3");
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (elapsedTime > CHANGE_DELAY_TIME)
            {
                ...
                int spriteNumber = rand.Next(0, 2 + 1);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Begin();
            spriteBatch.Draw(currentSprite, drawRectangle, Color.White); spriteBatch.Draw(currentSprite, drawRectangle, Color.White);
            spriteBatch.End();
